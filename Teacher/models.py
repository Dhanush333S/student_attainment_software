...
#all added
class see_perc(db.Model, UserMixin):
    id = db.Column(db.Integer(), primary_key=True)    
    usn = db.Column(db.String(length=15), nullable=False)
    coursecode = db.Column(db.String(length=20), nullable=False)
    co1p=db.Column(db.Float(), default=0)
    co2p=db.Column(db.Float(), default=0)
    co3p=db.Column(db.Float(), default=0)
    co4p=db.Column(db.Float(), default=0)
    co5p=db.Column(db.Float(), default=0)
    co6p=db.Column(db.Float(), default=0)
    co7p=db.Column(db.Float(), default=0)
    co8p=db.Column(db.Float(), default=0)
    co9p=db.Column(db.Float(), default=0)
    co10p=db.Column(db.Float(), default=0)
    def __repr__(self):
        return "SEE percentage upload"
